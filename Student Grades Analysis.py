...
# unique_grades_list = set()
# for student in students:
#     unique_grades_list.add(student[1])
#
# print(f"All of the Unique Grades: {unique_grades_list}")
...
# grade_list = []
# for person1 in students:
#     grade_list.append(person1[1])
#
#
# max_grade = []
# for i in range(3):
